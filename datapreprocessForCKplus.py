...
if len(sys.argv) != 1 :
		...
		exit(1)
ckp_groups_folder_path = 'I:\Data\CK+\CKplus10G'
#emotion_labels_path = 'I:/Data/CK'
tmdect = 'I:/Data/CK+/feat_log10groups_new'
...
cn=6
if cn==6:
    fi = open('I:\Data\CK+\CKplus10G\label6.txt')
else:
    fi = open('I:\Data\CK+\CKplus10G\label.txt')
flist = fi.readlines()
...
for id in range(len(imglist)):
    ...
    for i in range(len(imagelist)):
        ...
        if LOGP:#log the process
            ...
            cv2.imwrite(tmdect+'/'+imname+"_eye_new.jpg",imgr[4])
            cv2.imwrite(tmdect+'/'+imname+"_mid_new.jpg",imgr[5])
            cv2.imwrite(tmdect+'/'+imname+"_mou_new.jpg",imgr[6])
...
if SETLM and SETPM:
    filenametosave='I:/Data/CK+/D66501_CKplus_10G_V5_newGeo_newPatch_reproducelabel0to5.pkl'
elif SETLM:
    filenametosave='I:\Python\wlcTESTGEO\Datasets/D145_CKplus_10G_V4_Geo_xyc17to67_withstdXYandsmeformalized_withoutPatches.pkl'
    filenametosave='I:\Python\wlcTESTGEO\Datasets/D163_CKplus_10G_V5_NPfLCSAV3_withoutPatches.pkl'
elif SETPM:
    filenametosave='I:\Python\wlcTESTGEO\Datasets/D100_CKplus_10G_newM_withouGeometry.pkl'
