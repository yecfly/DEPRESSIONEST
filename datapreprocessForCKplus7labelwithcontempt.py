...
if len(sys.argv) != 1 :
		...
		exit(1)
ckp_groups_folder_path = 'I:/Data/CK+/CK+10GwithContempt'
#emotion_labels_path = 'I:/Data/CK'
tmdect = 'I:/Data/CK+/feat_log10groupswithcontempt_new'
...
tm=time.time()
#contempt is reset to last index 
fi = open('I:\Data\CK+\CK+10GwithContempt\label0to6.txt')
flist = fi.readlines()
...
if SETLM and SETPM:
    filenametosave='I:/Data/CK+/CK+10GwithContempt/D66505_CKplus_10G_V5_newGeo_newPatch_reproducelabel0to6_withContempt.pkl'
else:
    print('Set the file name first')
    exit()
